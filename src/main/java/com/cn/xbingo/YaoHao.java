...
public class YaoHao {
    final static long sleepTime = 2000;
    final static String baseUrl = "http://60.173.254.126:8888";
    final static String rsaUrl = baseUrl + "/details/getrsa/";
    final static String detailUrl = baseUrl + "/details/house/";
    final static String userAgent = "Mozilla/5.0 (Windows NT 6.1; rv:30.0) Gecko/20100101 Firefox/30.0";
